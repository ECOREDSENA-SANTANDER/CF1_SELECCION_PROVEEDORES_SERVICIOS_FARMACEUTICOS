  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Descripción de las características de los productos farmacéuticos
      ...
      .row.m-0.align-items-center.justify-content-center
        .col-lg-8.com.mb-0.mb-lg-0
          .bloque-texto-a__texto.p-lg-5.p-4.mb-lg-0.mb-4.my-3.my-lg-0
            p.mb-0 Los productos farmacéuticos son esenciales para la atención de la salud humana, ya que permiten intervenir en las distintas etapas del proceso salud-enfermedad: desde la prevención y el diagnóstico hasta el tratamiento, control y curación de múltiples patologías. En el contexto colombiano, estos productos están sujetos a rigurosos controles normativos, técnicos y sanitarios que buscan garantizar su seguridad, eficacia y calidad. La entidad responsable de esta regulación es el Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA), encargado de verificar el cumplimiento de los estándares definidos por la legislación nacional y las guías internacionales.
    ...
    #t_2_1.titulo-segundo.mb-5
      h2 2.1 Clasificación de productos farmacéuticos
      ...
      .row.m-0.align-items-center.justify-content-center
        .col-lg-8.mb-0.mb-lg-0
          .bloque-texto-a__texto.p-lg-4.p-md-4.p-4.mb-lg-0.mb-4.my-3.my-lg-0
            p.mb-0 La clasificación de productos farmacéuticos es el proceso de ordenar y agrupar los medicamentos y dispositivos médicos según criterios que permiten su identificación, control y manejo seguro. Esta organización es útil para la toma de decisiones clínicas, la gestión administrativa y la evaluación de riesgos, especialmente en procesos de contratación y selección de proveedores.
        .col-lg-4.col-md-6.col-9.mb-0
    ...
    SlyderF(columnas="col-lg-4 col-md-6 col-xl-4").mb-5
      .tarjeta.tarjeta--slyder.b2.p-2.p-lg-4.p-md-3
        .row.justify-content-center.align-items-center.mb-4
          ...
          h4.text-center.mb-0 De venta libre
        p.mb-4.text-center(data-aos="fade-right") Medicamentos que no requieren fórmula médica, ejemplo: acetaminofén.
      .tarjeta.tarjeta--slyder.b2.p-2.p-lg-4.p-md-3
        .row.justify-content-center.align-items-center.mb-4
          .col-8.mb-4.my-4
            img.img-a.img-t(data-aos="zoom-in-left")(src='@/assets/curso/tema2/15.svg' alt='AvatarTop')
          h4.text-center.mb-0 Con prescripción médica
        p.mb-4.text-center(data-aos="fade-right") Necesitan receta médica, ejemplo: antibióticos.
      .tarjeta.tarjeta--slyder.b2.p-2.p-lg-4.p-md-3
        .row.justify-content-center.align-items-center.mb-4
          .col-8.mb-4.my-4
            img.img-a.img-t(data-aos="zoom-in-left")(src='@/assets/curso/tema2/16.svg' alt='AvatarTop')
          h4.text-center.mb-0 Controlados
        p.mb-4.text-center(data-aos="fade-right") Medicamentos con riesgo de dependencia, ejemplo: morfina.
      .tarjeta.tarjeta--slyder.b2.p-2.p-lg-4.p-md-3
        .row.justify-content-center.align-items-center.mb-4
          .col-8.mb-4.my-4
            img.img-a.img-t(data-aos="zoom-in-left")(src='@/assets/curso/tema2/17.svg' alt='AvatarTop')
          h4.text-center.mb-0 Vitales no disponibles
    ...
    .bloque-texto-g.color-secundario.p-4.p-lg-5.p-md-4.mb-5(data-aos="fade-left")
      ...
      .bloque-texto-g__texto.p-lg-5.p-4.p-md-4
        p.mb-0 La calidad de los productos farmacéuticos en Colombia está regulada por un conjunto de normas que establecen los requisitos técnicos, sanitarios y documentales para su fabricación, almacenamiento, distribución y dispensación. Entre las principales normativas se encuentran:
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8
        ul.lista-ul--color.lista-ul--separador.mb-0
          li.d-flex.mb-2
            i.fas.fa-pills
            p.mb-0 #[b Resolución 1403 de 2007:] establece los lineamientos para la organización y funcionamiento de los servicios farmacéuticos, incluyendo los procedimientos técnicos para la gestión de medicamentos.
          li.d-flex.mb-2
            i.fas.fa-pills
            p.mb-0 #[b Resolución 1557 de 2023:] actualiza el procedimiento de habilitación de los servicios de salud, incorporando criterios técnicos aplicables a los servicios farmacéuticos.
          li.d-flex.mb-2
            i.fas.fa-pills
            p.mb-0 #[b Guías de Buenas Prácticas de Manufactura (BPM):] regulan los procesos de producción de medicamentos, y son de cumplimiento obligatorio para laboratorios nacionales e internacionales.
          li.d-flex.mb-2
            i.fas.fa-pills
            p.mb-0 #[b Buenas Prácticas de Almacenamiento (BPA):] definen las condiciones mínimas necesarias para preservar la calidad e integridad de los productos farmacéuticos a lo largo de la cadena logística.
          li.d-flex.mb-2
            i.fas.fa-pills
            p.mb-0 #[b Normas del INVIMA:] como autoridad sanitaria nacional, el INVIMA emite lineamientos sobre calidad, bioequivalencia, farmacovigilancia y registro sanitario.
          li.d-flex.mb-0
            i.fas.fa-pills
            p.mb-0 #[b Normas internacionales:] tales como la ISO 9001:2015 (gestión de la calidad) o los estándares de la Organización Mundial de la Salud (OMS) relacionados con la seguridad y calidad de los medicamentos.
      .col-lg-4.d-none.d-lg-block
        img(src='@/assets/curso/tema2/23.png', alt='Imagen decorativa')

    p.mb-4 La aplicación y referencia de estas normativas permite asegurar que los productos adquiridos cumplan con los estándares exigidos para proteger la salud pública y evitar sanciones regulatorias.
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              h4.mb-2.blu Dispensación y distribución de medicamentos
              p.mb-0 Para fortalecer el tema anteriormente abordado, se invita a consultar el siguiente enlace:
            .col-sm-auto
              a.boton.color-acento-botones(href="https://www.youtube.com/watch?v=oI5R6D2EPnU" target="_blank")
                span Abrir video
                i.fas.fa-file-video
